...
<html lang="en-us">
	<head>
	<?php $tpl->title = APP_NAME . " - Access Denied"; include("templates/core/head.tpl.php"); ?>
	</head>
	<body class="">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Errors <span>> 403 Access Denied</span></h1>
					</div>
				</div>
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
								...
								<div>
									...
									<div class="widget-body">
										<?php display_error("ERROR 403"," You have no access to the specified resource",false,false)?>
									</div>
								</div>
							</div>
						</article>
