          									...
          									<div class="padded">
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" name="contact_name" type="text" value="<?php echo $_POST['contact_name']?>">
															<div class="note">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" name="contact_email" type="text" value="<?php echo $_POST['contact_email']?>">
															<div class="note">
          ...
          <div class="tab-pane active" id="req">	
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" name="contact_mobile_nr" type="text" value="<?php echo $_POST['contact_mobile_nr']?>">
															<div class="note">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" name="pushover_key" id="pushover_key" type="text" value="<?php echo $_POST['pushover_key']?>">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" name="contact_callback" type="text" value="<?php echo $_POST['contact_callback']?>">
															<div class="note">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
								          	          		<div class="checkbox">
																<label>
																	<input type="checkbox" name="email_active" value="1" class="checkbox style-0"  id="s_mon_none">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
								          	          		<div class="checkbox">
																<label>
																	<input type="checkbox" name="sms_active" id="sms_active" value="1" class="checkbox style-0"  id="s_mon_none" <?php if(!$smsenabled) { echo 'disabled';}?>>
																	 <span>Send SMS</span>
																</label>
															</div>
														</div>
 												...
 												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
								          	          		<div class="checkbox">
																<label>
																	<input type="checkbox" name="tts_active" id="tts_active" value="1" class="checkbox style-0" id="s_mon_none" <?php if(!$ttsenabled) { echo 'disabled';}?>>
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
								          	          		<div class="checkbox">
																<label>
																	<input type="checkbox" name="pushover_active" value="1" class="checkbox style-0"  id="s_mon_none">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
								          	          		<div class="checkbox">
																<label>
																	<input type="checkbox" name="callback_active" value="1" class="checkbox style-0"  id="s_mon_none">
          	...
          	<table class="table table-normal">
          		<tr>
                   ...
                   <td style="padding-left: 175px">
						<?php renderTimeDropDown("s_mon_from","00:00"); ?>
						to
                    	<?php renderTimeDropDown("s_mon_to","24:00"); ?>          				
          			</td>
          			<td>
          					<div class="checkbox">
								<label>
									<input type="checkbox" name="s_mon_none" value="1" class="checkbox style-0"  id="s_mon_none">
          		...
          		<tr>
                   ...
                   <td style="padding-left: 175px">
						<?php renderTimeDropDown("s_tue_from","00:00"); ?>
						to
                    	<?php renderTimeDropDown("s_tue_to","24:00"); ?>          				
          			</td>
          			<td>
          					<div class="checkbox">
								<label>
									<input type="checkbox" name="s_tue_none" value="1" class="checkbox style-0"  id="s_tue_none">
									 <span>Disable Notifications for this day</span>
								</label>
							</div>          				
          			</td>          			
         		...
         		<tr>
          			...
          			<td style="padding-left: 175px">
						<?php renderTimeDropDown("s_wed_from","00:00"); ?>
						to
                    	<?php renderTimeDropDown("s_wed_to","24:00"); ?>          				
          			</td>  
          			<td>
          					<div class="checkbox">
								<label>
									<input type="checkbox" name="s_wed_none" value="1" class="checkbox style-0"  id="s_wed_none">
									 <span>Disable Notifications for this day</span>
								</label>
							</div>              				
          			</td>          			        			
          		...
          		<tr>
                   ...
                   <td style="padding-left: 175px">
						<?php renderTimeDropDown("s_thu_from","00:00"); ?>
						to
                    	<?php renderTimeDropDown("s_thu_to","24:00"); ?>          				
          			</td>
          			<td>
           					<div class="checkbox">
								<label>
									<input type="checkbox" name="s_thu_none" value="1" class="checkbox style-0"  id="s_thu_none">
									 <span>Disable Notifications for this day</span>
								</label>
							</div>                 				
          			</td>          			
          		...
          		<tr>
                   ...
                   <td style="padding-left: 175px">
						<?php renderTimeDropDown("s_fri_from","00:00"); ?>
						to
                    	<?php renderTimeDropDown("s_fri_to","24:00"); ?>          				
          			</td>
          			<td>
           					<div class="checkbox">
								<label>
									<input type="checkbox" name="s_fri_none" value="1" class="checkbox style-0"  id="s_fri_none">
									 <span>Disable Notifications for this day</span>
								</label>
							</div>            				
          			</td>          			
         		...
         		<tr>
          			...
          			<td style="padding-left: 175px">
						<?php renderTimeDropDown("s_sat_from","00:00"); ?>
						to
                    	<?php renderTimeDropDown("s_sat_to","24:00"); ?>          				
          			</td> 
          			<td>
           					<div class="checkbox">
								<label>
									<input type="checkbox" name="s_sat_none" value="1" class="checkbox style-0"  id="s_sat_none">
									 <span>Disable Notifications for this day</span>
								</label>
							</div>            				
          			</td>          			         			
         		...
         		<tr>
          			...
          			<td style="padding-left: 175px">
						<?php renderTimeDropDown("s_sun_from","00:00"); ?>
						to
                    	<?php renderTimeDropDown("s_sun_to","24:00"); ?>          				
          			</td> 
          			<td>
           					<div class="checkbox">
								<label>
									<input type="checkbox" name="s_sun_none" value="1" class="checkbox style-0"  id="s_sun_none">
									 <span>Disable Notifications for this day</span>
								</label>
							</div>            				
          			</td>          			         			
