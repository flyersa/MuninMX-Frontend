<?php
$fitem = getFirstCustomGraphItem($g->id);
$oitem = getOtherCustomGraphItemsAsHost($g->id);
?>
				<div class="row">
					<!-- NEW WIDGET START -->
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
								<header>
									...
									<h2>Edit <?php echo htmlspecialchars($g->graph_name)?></h2>
								</header>
								<!-- widget div-->
								<div>
									<!-- widget edit box -->
									...
									<div class="widget-body">
										<form class="smart-form" name="addForm" id="addForm" action="customs.php?action=edit&gid=<?php echo $g->id?>&token=<?php echo getToken()?>" method="POST">
												<fieldset>
													<div class="form-group">
														<label class="col-md-2 control-label">Enter a name for this custom graph</label>
														<div class="col-md-10">
															<input class="form-control" id="graph_name" name="graph_name" placeholder="Example: CPU Usage all CUSTOMER-X App Servers" type="text" value="<?php echo htmlspecialchars($g->graph_name)?>">
														</div>														
													</div>
												</fieldset>	
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" id="graph_desc" name="graph_desc"  placeholder="" type="text" value="<?php echo htmlspecialchars($g->graph_desc)?>">
														</div>														
													</div>
												</fieldset>	
													...
													<div class="form-group">
														...
														<div class="col-md-10">
															<select style="width:100%" name="groupname" class="select2">
																...
																<?php echo getGroupOptions($g->groupname);?>
															</select>
															<div class="note">
														...
														<div class="col-md-10" id="newmetricgroup">
															<select  style="width:100%" name="assigntogroup" id="assigntogroup" class="select2">
																...
																<?php 
																	...
																	{
																		echo getCustomMetricGroupOptions(getAssignedGroupFromCustomGraph($g->id));
																	}
																	else
																	{
																		echo getCustomMetricGroupOptions(getAssignedGroupFromCustomGraph($g->id),$_SESSION['user_id']);	
																	}
																?>
															</select>
															<div class="note">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<?php renderHostDropDown($fitem->hostname);?>
														</div>														
													</div>
												</fieldset>
												<fieldset>
													<div class="form-group">
														<label class="col-md-2 control-label">Select Hosts to include</label>
															<div class="col-md-10">
															<?php renderHostDropDownMultiTwo($oitem)?>
															</div>														
													</div>
												</fieldset>												
