							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<form class="smart-form" name="newCheckForm" id="newCheckForm" action="checks.php?action=edit&cid=<?php echo $check->id?>" method="POST">
												<fieldset>
													<div class="form-group">
														<label class="col-md-2 control-label">Name of Check</label>
														<div class="col-md-10">
															<input class="form-control" name="checkname" placeholder="Descriptive Name (Example: www.example.com https check)"  type="text" value="<?php echo htmlspecialchars($check->check_name)?>">
															<div class="note">
													...
													<div class="form-group">
														...
														<div class="col-md-10">
															<select name="interval" class="select2">
																<option value="1" <?php if($check->cinterval == 1) { echo 'selected';}?>>Every minute</option>
																<option value="5" <?php if($check->cinterval == 5) { echo 'selected';}?>>Every 5 minutes</option>
																<option value="10" <?php if($check->cinterval == 10) { echo 'selected';}?>>Every 10 minutes</option>
																<option value="15" <?php if($check->cinterval == 15) { echo 'selected';}?>>Every 15 minutes</option>
																<option value="20" <?php if($check->cinterval == 20) { echo 'selected';}?>>Every 20 minutes</option>
																<option value="30" <?php if($check->cinterval == 30) { echo 'selected';}?>>Every 30 minutes</option>
																<option value="60" <?php if($check->cinterval == 60) { echo 'selected';}?>>Every 60 minutes</option>
																<option value="720" <?php if($check->cinterval == 720) { echo 'selected';}?>>2x per day</option>
																<option value="1440" <?php if($check->cinterval == 1440) { echo 'selected';}?>>Once a day</option>
															</select>
															<div class="note">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" name="tags" id="tags" class="form-control" placeholder="linux,webserver,customername"  type="text" value="<?php echo getTagsForCheck($check->id)?>">
															<div class="note">
													...
													<div class="form-group">
														...
														<div class="col-md-10">
															<select name="accessgroup" class="select2 form-control">
																...
																<?php renderGroupDropDown($check->accessgroup)?>
															</select>
															<div class="note">
												...
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<select name="checktypee" id="checktype" disabled class="select2 checktype disabled">
																<?php
																$result = $db->query("SELECT * FROM check_types");
																while($tpl = $result->fetch_object())
																{
																	if($check->check_type == $tpl->id)
																	{
																		$sel = "selected";
																	}
																	else
																	...
																	echo '<option value="'.$tpl->id.'" '.$sel.'>'.$tpl->check_name.'</option>';	
																}
																?>
															</select>
															<div class="note">
													...
													<input type="hidden" name="checktype" value="<?php echo $check->check_type?>">
												</fieldset>													
													...
													<div class="form-group">
														...
														<div class="col-md-10">
															<?php 
																...
																{
																	renderContactDropDownForCheckEdit($check->id);
																}
																else
																{
																	renderContactDropDownForCheckEdit($check->id);	
