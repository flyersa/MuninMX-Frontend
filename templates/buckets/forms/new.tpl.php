							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
								...
								<div>
									...
									<div class="widget-body">
										<form class="smart-form padding-5" name="addForm" id="addForm" action="buckets.php?action=add" method="POST">
										<fieldset>
													<div class="form-group">
														<label class="col-md-2 control-label">Enter a name for this graph</label>
														<div class="col-md-10">
															<input class="form-control" id="statname" name="statname" placeholder="Example: Votes received on custom application A" type="text">
														</div>														
													</div>
												</fieldset>	
												<fieldset>
													<div class="form-group">
														...
														<div class="col-md-10">
															<input class="form-control" id="statlabel" name="statlabel"  placeholder="Example: Requests/second" type="text">
														</div>														
													</div>
												</fieldset>	
